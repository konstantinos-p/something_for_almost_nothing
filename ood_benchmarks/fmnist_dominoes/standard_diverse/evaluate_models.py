from utils.train import evaluate_ensemble, evaluate_saved_models
from utils.benchmarking_algorithms.agree_to_disagree_ensemble import get_simple_ood_datasets
import sys
import getopt
...
def get_conf_and_evaluate(argv):
    ...
    *** This fails silently when the correct folder is not given. ***
    ...
    train_ds, test_ds, unlabeled_ds, validation_ds = get_simple_ood_datasets(cfg=cfg)
    if mode == 'single':
