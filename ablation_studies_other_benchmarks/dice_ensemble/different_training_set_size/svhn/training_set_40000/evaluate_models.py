from utils.benchmarking_algorithms.dice_ensemble import evaluate_ensemble, evaluate_saved_models, get_datasets
import sys
import getopt
...
def get_conf_and_evaluate(argv):
    ...
    *** This fails silently when the correct folder is not given. ***
    ...
    if mode == 'single':
        res = evaluate_saved_models(path_to_model + '/ckpts/network_0', path_to_model + '/ckpts/classifier_0', cfg=cfg, split_ds=test_ds)
    elif mode == 'ensemble':
